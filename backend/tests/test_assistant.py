...
def test_responses_provider_uses_typed_tools_without_remote_history():
    ...
    for payload in captured:
        ...
        assert {tool["name"] for tool in payload["tools"]} == {"schedule", "search_documentation", "lookup_iri", "competition_regulations", "compare_regulations"}
...
def test_provider_shared_circuit_answer_has_sources_iris_and_asserted_premises():
    ...
    for payload in captured:
        assert {tool["name"] for tool in payload["tools"]} == {"schedule", "search_documentation", "lookup_iri", "competition_regulations", "compare_regulations", "graph_shared_circuits", "graph_query"}
